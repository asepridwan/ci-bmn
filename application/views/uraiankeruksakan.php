    						...
    						<div class="widget-area no-padding blank">
								<div class="status-upload">
									<form method="post" action="">
										<textarea name="uraiankeruksakan" required placeholder="Uraian Keruksakan" ></textarea>
										<ul>
										...
										<button type="submit" class="btn btn-success green"><i class="fa fa-share"></i> Kirim</button>
									</form>
								</div><!-- Status Upload  -->
							</div><!-- Widget Area -->
						</div>
