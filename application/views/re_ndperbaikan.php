...
$txt3='	<strong>NOTA DINAS</strong>
				<br>
				Nomor : BM.3.7/................................................................/'.$tgl->format('m').'/'.$tgl->format('Y').'
				<br>
        ';
...
$txt6=   '<table>
          ...
          <p>Perlu dilakukan perbaikan/service karena mengalami keruksakan atau perangkat tidak berfungsi baik sebagaimana mestinya.
          Sehubungan dengan hal tersebut diatas, kami mohon kiranya dapat dilaksanakan perbaikan/service dalam waktu yang tidak terlalu lama.
          Atas perhatian dan bantuan Saudara, kami ucapkan terima kasih.</p>
          ';
...
$pdf->WriteHTML($txt6,true,false,false,false,'J');
	...
	$txt7='	<table>
              ...
              <td width="58%"></td>
              <td width="2%"></td>
              <td width="40%">Jakarta, '.$tgl->format('d').' '.$bulan[$tgl->format('m')].' '.$tgl->format('Y').'<br>PNS yang melaporkan</td>
            </tr>
            <tr>
              <td></td>
              <td></td>
