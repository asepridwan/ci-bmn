...
<head>
  ...
  <title>BAGIAN PENGELOLAAN BMN</title>
...
<body id="page-top">
  ...
  <header class="masthead">
    <div class="container h-100">
      <div class="row h-100">
        <div class="col-lg-0 my-auto">
          <div class="header-content mx-auto">
            <h1 class="mb-5">UNIT BIRO UMUM, BAGIAN PENGELOLAAN BARANG MILIK NEGARA</h1>
            ...
            <div class="device-mockup iphone6_plus portrait black">
              <div class="device">
                <div class="screen">
                  ...
                  <img src="<?= base_url()."assets/img/demo-screen-1-Copy.jpg" ;?>" class="img-fluid" alt="">
                </div>
                <div class="button">
  ...
  <footer>
    <div class="container">
      <p>&copy; bmn.ekon.go.id 2019. Semua Hak Dilindungi.</p>
